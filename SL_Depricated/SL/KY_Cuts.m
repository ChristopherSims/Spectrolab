...
line([DKX DKX],[KY_Angle_Min KY_Angle_Max], 'color', 'magenta', 'linewidth', 1,'linestyle','--')
text(DKX,KY_Angle_Min + 0.2,num2str(ii),'color','magenta','FontSize',12, 'FontWeight','bold')
